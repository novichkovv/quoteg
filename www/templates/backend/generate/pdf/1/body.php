    ...
    <div class="row">
        ...
        <div class="col35">
            <div class="row">
                ...
                <div class="col50">
                    <?php echo date('d M, Y', strtotime($quote['expiration_date'])); ?>
                </div>
            </div>
            <div class="row">
                <div class="col50">
...
<div class="text-center">
    <table border="1" cellspacing="0" style="margin: auto; page-break-inside: avoid;">
        ...
        <tr><td> BIM Drafting Engineer	</td><td>$ 55.00/hr</td></tr><tr><td>
                ...
                BIM Consulting	</td><td>$ 100.00/hr</td></tr>
        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
        <tr><td>

                2D Drafting Engineer	</td><td>$ 50.00/hr</td></tr><tr><td>
                Rendering Artist	</td><td>$ 50.00/hr</td></tr><tr><td>
                Steel Detailing Engineer	</td><td>$ 50.00/hr</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>

                Quantity Engineer	</td><td>$ 35.00/hr</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>

                Administrative/Clerical	</td><td>$ 25.00/hr</td></tr><tr><td>
                Quality Control/ Project Manager	</td><td>$ 90.00/hr</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>

                LEED AP Project Coordinator	</td><td>$ 50.00/hr</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>
    ...
    <br><br>
    <table align="left" class="t1" style="margin: auto;  page-break-inside: avoid; text-align: left !important; ">
        <thead>
        <tr>
        ...
        <tbody>
        <tr><td> Subconsultants   </td><td>Cost plus 15%</td></tr>
        <tr>
            <td>Prints/Scanning – Color</td>
            <td>$ 9.00 per sheet</td>
        </tr>
        <tr>
            <td>
                Prints/Scanning – Black and White
            </td><td>$ 4.00 per sheet</td>
        </tr>
        <tr>
            <td>
                Computer Disks</td>
            <td>$ 10.00 per disk</td>
        </tr>
        <tr>
            <td>
                Mail/Shipping
...
<div class="row" style="font-size: 11px;">
    ...
    Product to be provided under this Agreement.  VIATechnik shall cause such designee to be reasonably and promptly available to coordinate with Clientso that the objectives
    of this Agreement can be timely carried out to the satisfaction of the parties.   <br><br><span style="text-decoration: underline;">3. CONFIDENTIAL INFORMATION</span>. If VIATechnik or Client supplies proprietary or confidential information to the other party in connection with this Agreement that is
    identified as, or that the other party should have known is, confidential, then the other party agrees to (a) protect the confidential information in a reasonable manner and
    (b) use and reproduce confidential information only as required to perform its obligations under this Agreement. This Section will not apply to information that is publicly
    known, already known to the receiving party, disclosed to a third party without restriction, or disclosed pursuant to legal requirement or order.  Subject to the foregoing,
    VIATechnik may disclose Client’s confidential information to VIATechnik’s employees, contractors and subcontractors in order to perform the Services.<br><br><span style="text-decoration: underline;">4. INVOICE AND PAYMENT PROCEDURES</span>. VIATechnik shall submit invoices, once a month, at a minimum, to the Client for Services rendered during each calendar month.
    The Client, as the Client or authorized agent for the  Client, hereby agrees that payment will be made for said Services within thirty (30) days from the date of invoice; and,
    in default ofsuch payment, hereby agreesto pay all cost of collection, including reasonable attorney’sfees, regardless of whether legal action isinitiated.  The Client hereby
    acknowledges that unpaid invoices shall accrue interest at 2 percent per month after they have been outstanding for over thirty (30) days.  If an invoice remains unpaid
    over thirty (30) days, VIATechnik may terminate the provision of its Services until such payment default is cured.  If any payment default fails to be cured for longer than
     45 days from the date of the invoice, VIATechnik may at its option terminate this Agreement, whereupon the terms of Section 11 shall govern.<br><br><span style="text-decoration: underline;">5. SCOPE OF WORK</span>. The estimation of quantity and total price provided by VIATechnik in the Proposal are good faith estimates based on the plans, drawings and other
    information provided by the Client as of the date of the Proposal.  There is no guarantee that the Services will be completed within such quantity or price. In the event of
    any change in the (a) plans and designs, and other Client’s requirements related to the work, (b) any applicable law and regulations effecting the Services and (c) any other
    reason not contemplated on the date of the Proposal, additional work will be included as Services, and such  additional work shall be paid for by the Client.  VIATechnik
    agrees to provide to Client a written notice of any work modifications requiring more than [20%] in variation from the fees quoted in the Proposal, and Client will be
    deemed to have accepted such revised Proposal and estimated fees unless a notice of objection is delivered to VIATechnik within five business days of receipt of such
    notice from VIATechnik.  <br><br><span style="text-decoration: underline;">6. WORK PRODUCT</span>. Upon payment of all amounts due to VIATechnik in connection with this Agreement, Client shall own all right, title, and interest in the Work Product.  
    The foregoing notwithstanding, Work Product shall not include pre‐existing materials, software, or applications that are owned by VIATechnik or licensed to VIATechnik by
    third parties and that VIATechnik usesin the performance of the Services, derivative works deriving from or based on any of the foregoing, or any ideas, concepts, methods,
    techniques, processes, procedures or know‐how embodied by or incorporated into the deliverables that VIATechnik provides to you (collectively, “Tools”).  All right, title,
    and interest in and to the Tools shall remain VIATechnik’s (or the applicable third party’s) exclusive property.  If Client has any issue or problem with the Work Product or
    Services provided by VIATechnik or its contractors or employees under this Agreement, Client must provide written notice of such issue or problem within 30 days of the
    delivery of such Work Product or Services.  Client represents, warrants and covenants that Client solely responsible for reviewing all Work Product and shall be responsible
    to any third party beneficiaries of the Work Product or other persons or entities that may rely on the Work Product.   <br><br><span style="text-decoration: underline;">7. MISCELLANEOUS EXPENSES</span>. The Client shall pay the costs of all fees, permits, bond premiums, scanning and reproductions, travel, and all other charges related to the
    work and the Services, other than those charges which VIATechnik specifically agrees to pay under this Agreement.  <br><br><span style="text-decoration: underline;">8. REUSE OF PROJECT DELIVERABLES</span>. Reuse of any documents or other deliverables, including electronic media, pertaining to the Services by the Client for any purpose
    other than that for which such documents or deliverables were originally prepared, or alternation of such documents or  deliverables without written verification or
    adaption by VIATechnik for the specific purpose intended, shall be at the Client’s sole risk.<br><br><span style="text-decoration: underline;">9. RELIANCE ON THE CLIENT DOCUMENTS</span>.  VIATechnik shall rely on the accuracy, completeness and adequacy of all plans, designs, drawings, instructions and other
    documents and information provided by the Client and any of its contractors, representatives and agents (“Client Documents”).   Client agrees to indemnify, defend, and
    hold harmless VIATechnik and any of its Clients, directors, officers, employees and agents (“VIATechnik Party”) from and against any loss, liability and damages sustained
    by them resulting from any of VIATechnik Party’s use or reliance on such Client Documents.  <br><br><span style="text-decoration: underline;">10. OPINIONS OF CONSTRUCTION COST</span>. Any opinion of construction costs prepared by VIATechnik is supplied for the general guidance of the Client only. Since VIATechnik
    has no control over competitive bidding or fluctuating market conditions, VIATechnik cannot guarantee the accuracy of such opinions.<br><br><span style="text-decoration: underline;">11. INDEMNITY</span>. To the fullest extent permitted by law, each party (“Indemnifying Party”) shall indemnify and save harmless the other party, its Clients, directors, officers,
    employees and agents (“Indemnified Party”) from and against loss, liability, and damages sustained by the Indemnified Party as a result of Indemnifying Party’s breach of
    this Agreement or the negligence of the Indemnifying Party, its employees or agents.    The Indemnifying Party’s liability to indemnify hereunder shall be reduced
    proportionately to the extent that any acts or omissions of the Indemnified Party contributed to such claim, liability or loss.<br><br><span style="text-decoration: underline;">12. DISCLAIMERS OF ALL WARRANTIES</span>. VIATechnik hereby disclaims all warranties, whether express or implied, with respect to the services and the word product,
    including by not limited to, any implied warranty of merchantability, fitness for particular purpose and/or title and, except as set forth in these terms and conditions, the
    services and the work product are provided “as is”.<br><br><span style="text-decoration: underline;">13. LIMITATIONS OF LIABILITY</span>.  NEITHER PARTY WILL BE LIABLE (WHETHER IN CONTRACT, WARRANTY, TORT (INCLUDING  NEGLIGENCE),  OR  OTHER  THEORY),  TO  THE
    OTHER PARTY OR ANY OTHER PERSON OR ENTITY FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE OR EXEMPLARY DAMAGES (INCLUDING
    DAMAGES FOR LOSS OF PROFIT) ARISING OUT OF THIS AGREEMENT.   No employee of VIATechnik shall have individual liability to Client.    Client agrees that, to the
    fullest extent permitted by law, VIATechnik’s total liability to Client for any and all injuries, claims, losses, expenses or damages whatsoever arising out of or in any way
    related to the Services or this Agreement from any causes including, but not limited to, VIATechnik’s negligence, error, omissions, strict liability, or breach of contract
    shall not exceed the total compensation received by VIATechnik under this Agreement. If the Client desires a limit of liability greater than provided above, the Client and
    VIATechnik shall include in the Agreement the amount of such limit and the additional compensation to be paid to VIATechnik for assumption of such risk.
     343 W. Erie Street Suite 410  •  Chicago, Illinois 60654   •   312.462.1060
    www.viatechnik.com<br><br><span style="text-decoration: underline;">14. TERMINATION</span>.  This Agreement may be terminated (a) by mutual agreement by the parties (b) by delivery of a termination notice in case either party is in breach
    and fails to cure such breach within ten days of a written notice thereof (c) automatically without notice in case either party voluntarily or involuntarily files for
    bankruptcy or liquidation.  Upon termination of this Agreement for any reason, the Client shall pay VIATechnik all fees for the Services carried out up to and including the
    date of termination together with payment of any costs and expenses incurred VIATechnik to that date.<br><br><span style="text-decoration: underline;">15. NON‐SOLICITATION</span>. During the term of this Agreement and for a period of 6 months after the Termination Date, Client shall not, directly or indirectly, without
    VIATechnik’s prior written consent, recruit, hire or contract with any current or former employee or contractor of VIATechnik, or any of VIATechnik’s affiliates, or otherwise
    attempt to solicit or induce any such individuals to leave the employment of or terminate his/her relationship with VIATechnik or VIATechnik’s affiliates.   <br><br><span style="text-decoration: underline;">16. AUTHORITY</span>. The persons signing this Agreement warrant that they have the authority to sign as, or on behalf of, the party for whom they are signing.<br><br><span style="text-decoration: underline;">17. STATUTE OF LIMITATIONS</span>. To the fullest extent permitted by law, parties agree that, except for claimsfor indemnification, the time period for bringing claimsregarding
    VIATechnik’s performance under this Agreement shall expire one year after the completion of Services.<br><br><span style="text-decoration: underline;">18. ENTIRE AGREEMENT; AMENDMENTS</span>. This Agreement constitutes the entire Agreement between the parties and contains all of the agreements between the parties
    with respect to the subject matter hereof; this Agreement supersedes any and all other agreements, either oral or in writing, between the parties hereto with respect to
    the subject matter hereof.  No change or modification of this Agreement shall be valid unless the same is in writing and signed by the parties. No waiver of any provision
    of this Agreement shall be valid unless in writing and signed by the person or party to be charged.<br><br><span style="text-decoration: underline;">19. GOVERNING LAW; VENUE</span>.  The laws of the State of Illinois (without giving effect to its conflict of laws principles) govern all matters arising out of or relating to this
    Agreement.  The parties agree that any cause of action that may arise in any way under or due to this Agreement shall only be brought in state or federal courts located in
    the County of Cook, Illinois.<br><br><span style="text-decoration: underline;">20. ATTORNEY’S FEES</span>.  Client shall be responsible for all fees and expenses (including, but not limited to, attorneys’ fees and expenses) incurred by VIA in connection with
    the enforcement of this Agreement, including, but not limited to, the collection of amounts owed to VIA under this Agreement. 
</div>
<div class="row" style="font-size: 11px;">
